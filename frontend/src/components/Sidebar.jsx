  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 right-4 z-[60] md:hidden w-10 h-10 bg-[#18181b] border border-white/10 rounded-lg flex items-center justify-center text-white"
      ...
      {/* Sidebar */}
      <aside 
        className={`fixed top-0 right-0 h-full bg-[#18181b] border-l border-white/10 z-[70] transition-all duration-300 flex flex-col
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between border-b border-white/10 px-4">
          {!sidebarCollapsed ? (
            ...
            <span className="text-2xl font-bold text-indigo-500 mx-auto">T</span>
          )}
        ...
        <button
          ...
          className="hidden md:flex absolute top-1/2 -left-3 transform -translate-y-1/2 w-6 h-6 bg-[#27272a] border border-white/10 rounded-full items-center justify-center text-zinc-400 hover:text-white hover:border-indigo-500/50 transition-colors"
